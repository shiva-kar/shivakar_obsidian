...
## Why it exists
Reduce latency, CPU, and memory costs.
...
## Code Pattern
```c
// profile hotspot, then optimize loop/data layout
```

## Common Mistakes
- Premature optimization
- Ignoring compiler warnings and profiling

## Interview Angle
- O-notation vs real-world profiling
- Compiler flags and tradeoffs
