...
- [x] **1.** Show the following patterns using just print statements: ✅ 2025-12-13
...
- [x] **2.** Show the following patterns using just print statements: ✅ 2025-12-13
...
- [ ] **3.** Create a program to input the name of a person and respond with "Welcome NAME to KG Coding".
    
- [ ] **4.** Create a program to declare two integer variables, assign them values, and display their values.
    
- [ ] **5.** Create a program that declares one variable of each of the fundamental data types (`int`, `float`, `double`, `char`) and prints their size using the `sizeof()` operator.
...
- [ ] **8.** Create a program to define a constant for the mathematical value $\pi$ (3.14159) and use it to calculate and print the circumference of a circle with a radius input from the user.
    
- [ ] **9.** Create a program to print the area of a circle by inputting its radius.
    
- [ ] **10.** Create a program to swap two numbers.
    
- [ ] **11.** Create a program that takes two numbers and shows the result of all arithmetic operators (`+`, `-`, `*`, `/`, `%`).
    
- [ ] **12.** Given an integer value, convert it to a floating-point value and print both.
    
- [ ] **13.** Create a program to calculate the product of two floating-point numbers.
    
- [ ] 14. Create a program to calculate the Perimeter of a rectangle.
...
- [ ] **24.** Create a program that categorizes a person into different age groups:
...
- [ ] **25.** Create a program to find the minimum of two numbers using the ternary operator.
    
- [ ] **26.** Create a program to find if the given number is even or odd using the ternary operator.
    
- [ ] **27.** Create a program to calculate the absolute value of a given integer using the ternary operator.
    
- [ ] **28.** Based on a student's score, categorize as "High", "Moderate", or "Low" using the ternary operator (e.g., High for > 80, Moderate for 50-80, Low for < 50).
    
- [ ] **29.** Create a program to print the month of the year based on a number (1-12) input by the user.
    
- [ ] **30.** Create a simple calculator that uses a `switch` statement to perform basic arithmetic operations like addition, subtraction, multiplication, and division.
...
- [ ] 42. Create a program that prints the following patterns:
...
- [ ] **45.** Create a program using a `for` loop to display the multiplication table for a number.
